...
#
Summary:	The lossless True Audio codec ANSI-C library
...
# Source0-md5:	fd0ff4806b2badfe933adf87efbfc3ae
...
install -Dp libtta.h $RPM_BUILD_ROOT%{_includedir}/libtta.h
...
%doc README
%attr(755,root,root) %{_bindir}/tta
